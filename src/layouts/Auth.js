  ...
  return (
    <>
      ...
      <div className="main-content">
        <div className="header bg-gradient-default2" style={{ paddingTop: "60px", paddingBottom: "50px", background: "linear-gradient(87deg, #E3EAFF 0, #c4d5ff 100%)" }}>
          <Container>
            <div className="header-body text-center mb-7">
              <Row className="justify-content-center">
                <Col lg="5" md="6">
                  <img src={Brand2} alt="Osecac" style={{ width: "250px" }} />
                  <h1>Delegación Córdoba</h1>
                  <h1>Contaduría</h1>
                </Col>
              </Row>
            </div>
