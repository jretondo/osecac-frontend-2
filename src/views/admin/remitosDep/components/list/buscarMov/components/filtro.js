            ...
            <Row form style={{ textAlign: "left" }}>
                <Col md={12}>
                    <Row>
                        <Col md="8">
                            <FormGroup>
                                <Label for="concTxt">Concepto o Importe:{" "}</Label>
                                <Input type="text" id="concTxt" required value={filtroStr} onChange={e => { setFiltroStr(e.target.value) }} disabled={buscar} placeholder="Concepto, OP, Nº Boleta o Importe..." />
                            </FormGroup>
                        </Col>
                        <Col md="4">
                            <FormGroup>
                                <Label for="concTxt">Tipo de Deposito:{" "}</Label>
                                <Input onChange={(e) => setTipo(e.target.value)} value={tipo} type="select" name="select" id="exampleSelect">
                                    <option value={0}>Todos</option>
                                    <option value={1}>Coseguro</option>
