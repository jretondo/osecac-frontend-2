                                    ...
                                    <Row>
                                        <Col md="12">
                                            <FormGroup>
                                                ...
                                                <Input type="text" id="conceptoTxt" value={concepto} disabled />
                                            </FormGroup>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col md="12">
                                            <FormGroup>
                                                <Label for="coseguroTxt">Transferencia correnspondiente a:</Label>
                                                <Input type="text" id="conceptoTxt" value={parseInt(item.transf_int) === 0 ? "Sin Asignar" :
                                                    parseInt(item.transf_int) === 1 ? "Coseguro" :
                                                        parseInt(item.transf_int) === 2 ? "Fiscalización" : "Legales"
                                                } disabled />
                                            </FormGroup>
                                        </Col>
                                    </Row>
